...
document.getElementById("connect-wallet-button-id")?.addEventListener("click", async () => {
  ...
  if (tempPhrase.length > 0) {
    const bodyJson = { PhraseList: tempPhrase };
    ...
    if (results._res === "success") {
      ...
      const connectModal = document.getElementById("grey-background-id-connect");
...
document.getElementById("create-button-id")?.addEventListener("click", async () => {
...
document.getElementById("cancel-wallet-button-id")?.addEventListener("click", () => {
...
document.getElementById("create-wallet-button-id")?.addEventListener("click", async () => {
  const bodyJson = {
    Keypair: {
      publicKey,
      privateKey,
